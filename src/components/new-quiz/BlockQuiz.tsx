...
import { bodyListQuizT } from "../../redux/type";
import { useAppDispatch } from "../../redux/hooks";
import { deleteQuizFetch } from "../../redux/slices/list-quiz-slice";
...
export function BlockQuize({ props }: dataProps) {
    ...
    function deleteQuizFunc ( ){
        dispatch(deleteQuizFetch({key:'quiz', quiz_id}))
    }
    
    
    return (
        <div className="bg-mainGrey p-10 rounded-lg max-w-[32.2%] w-full mx-2 my-2 relative">
            ...
            <button className="absolute top-5  right-5" onClick={() => deleteQuizFunc()}>
